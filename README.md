...
![image](https://user-images.githubusercontent.com/97004744/181391329-daa01101-0f40-41ad-981e-c9ba23f683d4.png)
...
* Request
  * Method: POST
  * URL: /users/current/albums/:id/addsong
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /users/current/playlists/new
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /users/current/playlists/:id/addsong
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PATCH
  * URL: /users/current/playlists/:id
  * Headers:
    * Content-Type: application/json
  * Body:
